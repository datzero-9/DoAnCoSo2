<style>
    * {
    ...
    .container1 ul li:nth-child(1) h2 {
        height: 48px;
        width: 100%;
        margin: 0 0 0 20px;
    }
        ...
        <ul style="padding: 0 10px;">
            ...
            <li>
                @if (Auth::check())
                    ...
                    <b>{{ Auth::User()->name }}</b>
                @else
                    <div class="d-flex align-items-center"><a href="{{ route('login') }}">Đăng nhập </a><i
                ...
                $.ajax({
                    ...
                    success: function(req) {
                        ...
                        for (var product of req) {
                            ...
                            _html +=
                                `<span>${product.name.length > 20 ? product.name.slice(0, 30) + '...' : product.name}</span> <br>`;
                            _html += '</a>';
                            _html += '</div>';
                        }
