                ...
                <div class="slider-content">
                    ...
                    <div class="slider-content-left">
                        <div class="slider-content-left-top-container">
                            <div class="slider-content-left-top">
                                <a href="#"><img
                                        src="https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_100/https://cdn.tgdd.vn/2023/12/banner/720x220-min-720x220-1.png"
                                        alt=""></a>
                                <a href="#"><img
                                        src="https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_100/https://cdn.tgdd.vn/2023/11/banner/IP15-720-220-720x220-3.png"
                                        alt=""></a>
                                <a href="#"><img
                                        src="https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_100/https://cdn.tgdd.vn/2023/12/banner/720x220Xahangbackuppng-720x220.png"
                                        alt=""></a>
                                <a href="#"><img
                                        src="https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_100/https://cdn.tgdd.vn/2023/11/banner/Vivo-Y17s-720-220-720x220-3.png"
                                        alt=""></a>
                                <a href="#"><img
                                        src="https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_100/https://cdn.tgdd.vn/2023/12/banner/dh-befit-720-220-720x220.png"
                                        alt=""></a>
                    ...
                    <div class="slider-content-right">
                        @foreach ($newProduct as $item)
                            <p style="margin: 0;top: 0;" class="text-center">
                                <strong>{{ Str::limit($item->name, 20, '...') }}</strong></p>
                            <div><a href="{{ route('detail', $item->slug) }}"> <img
                    ...
                    @foreach ($hotproducts as $item)
                        <div class="col-md-4 col-sm-6 col-lg-3 sanphamnoibat">
                            ...
                            "
                                        ...
                                        <button type="submit"
                                            class="border border-0 position-absolute start-0 bg-success rounded-end-circle"
                                            style="width:60px;top:5px;borber:none;"><b>Hot</b></button>
                                        @if ($item->sale_price > 0)
                                            <button type="submit"
                                                class="border border-0 position-absolute start-0 bg-danger rounded-end-circle"
                                                style="top:40px;width:60px;"><b>{{ percent($item->sale_price, $item->price) }}%</b></button>
                                        @endif
                                    </a>
                                    <div class="card-body">
                                        <a href="#" class="nameproduct">
                                            <h6><strong>{{ Str::limit($item->name, 17, '...') }}</strong></h6>
                                        </a>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <small class="text-muted text-right">
                                                ...
                                                @if ($item->sale_price > 0)
                                                    ...
                                                    <b style="color: #DC3545;">đ{{ number_format($item->sale_price) }} </b>
                                                    <br>
                                                @else
                                                    <b style="color: #DC3545;">đ{{ number_format($item->price) }} </b><br>
                                                @endif
                                                <i>Sản phẩm <strong>uy tín</strong>, <strong>chất lượng</strong> 100%, có
                                                    <strong>bảo hành</strong></i>
                                            </small>
                                        </div>
                                        <div class="btn-group mt-3 d-flex justify-content-right">
                                            <a class="btn btn-sm btn-outline-secondary"
                                                href="{{ route('detail', $item->slug) }}">Xem
                                                chi tiết</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @foreach ($allProduct as $item)
                        <div class="col-md-4 col-sm-6 col-lg-3">
                            ...
                            "
                                ...
                                <div class="card-body">
                                    <a href="#" class="nameproduct">
                                        <h6><strong>{{ Str::limit($item->name, 15, '...') }}</strong></h6>
                                    </a>
                                    <h6><strong>Sản phẩm</strong>: {{ $item->category->name ?? 'none' }}</h6>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <small class="text-muted text-right">
