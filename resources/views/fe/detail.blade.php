                            ...
                            <div class="preview col-md-5 mb-3">
                                ...
                                <div class="container">
                                    ...
                                    <div class="list_image">
                                        <div class="active"><img src="{{ asset('storage/images') }}/{{ $product->image }}">
                                        </div>

                                        @foreach ($product->images as $item)
                                            <div><img src="{{ asset('storage/images') }}/{{ $item->image }}"
                                                    alt=""></div>
                                        @endforeach
                            ...
                            <div class="details col-md-7 mb-3">
                                <div class="container">
                                    ...
                                    @if ($product->sale_price > 0)
                                        <small class="">Giá cũ: <s><span>{{ number_format($product->price) }}
                                                    vnđ</span></s></small><br>
                                        <small class=" text-danger">Giảm:
                                            {{ percent($product->sale_price, $product->price) }}%</small>
                                        <h4 class="price">Giá hiện tại: <span
                                                class="text-danger">{{ number_format($product->sale_price) > 0 ? number_format($product->sale_price) : number_format($product->price) }}
                                                vnđ</span></h4>
                                    @else
                                        <h4 class="price">Giá hiện tại: <span
                                                class="text-danger">{{ number_format($product->sale_price) > 0 ? number_format($product->sale_price) : number_format($product->price) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-btn">
                                                    <button type="button" class="btn btn-default btn-number fs-5 border"
                                                ...
                                                <input type="text" id="quantity" name="quantity"
                                                    ...
                                                    value="{{ old('quantity') ? old('quantity') : 1 }}" min="1"
